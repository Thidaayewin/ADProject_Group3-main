...
$(document).ready(function() {
  ...
  $.ajax({
      url: "/api/rainfall/getRainfallMeanSquareError",
      type: "GET",
      data: {
      ...
      success: function(responseData) {
          ...
          var dom = document.getElementById('mean-container');
        ...
        for (let i = 0; i < laNinaGroups.length; i++) {
          ...
          option = {
            title: {
              text: 'Rolling Root Mean Squared Error over time, Window = '+filterData.wRMSE,
              textStyle: {
                fontSize: 12,
                align: 'center', 
